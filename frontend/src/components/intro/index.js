...
export default function Intro({ detailss, simulation, visitor, setOthername }) {
  ...
  return (
    <div className="profile_card">
      ...
      {simulation?.organizations?.map((organization) => (
        <div className="info_profile" key={organization}>
          <img src="../../../icons/public.png" alt="" />
          Public organization: <b>{organization}</b>
        </div>
      ))}
      {simulation?.clues?.map((clue) => (
        <div className="info_profile" key={clue}>
          <img src="../../../icons/public.png" alt="" />
          Public clue: <b>{clue}</b>
        </div>
      ))}
      {!visitor && (
        <button
